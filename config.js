...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/RiZfSUE.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐂𝚫𝚻 𝐒𝚸𝐘;𝛭𝑈𝛨𝛥𝛭𝛭𝛯𝐷;https://i.imgur.com/RiZfSUE.jpeg;https://chat.whatsapp.com/Gz866L8ZATyJvDx6YZHctQ',
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐂𝚫𝚻 𝐒𝚸𝐘',
    ...
    ANTILINK_WARN: process.env.ANTILINK_WARN || 'remove',
    HEROKU: {
